...
import static com.example.mymusicplayer.MyPlayerActivity.listSongs;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    void seekTo(int posiion){
        mediaPlayer.seekTo(posiion);
    }
    ...
    void showNotification(int playPauseBtn){
        ...
        Intent pauseIntent = new Intent(this,NotificationReceiver.class).setAction(ACTIONPLAY);
        ...
        {
            thumb = BitmapFactory.decodeResource(getResources(),R.drawable.ks);
        }
